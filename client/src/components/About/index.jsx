        ...
        <div className={style.presentBlockContent}>
          ...
          <div className={style.presentBlockContent__row}>
            <p className={style.presentBlockContent__rowText}>
              A company founded by a team of professional enthusiasts who have
              set themselves the goal of creating a truly exclusive car rental
              service that is unique for our country. With us, you do not need
              to spend time and money on regular repairs, paying high taxes and
              seasonal storage of your car. You just have to enjoy the
              indescribable emotions from driving the car of your dreams.
            </p>
            <p className={style.presentBlockContent__rowText}>
